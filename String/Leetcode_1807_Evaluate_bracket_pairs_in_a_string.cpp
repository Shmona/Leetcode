...
"age".You know the values of a wide range of keys. This is represented by a 2D string array knowledge where 
...
keyi, you will: Replace keyi and the bracket pair with the key's corresponding valuei.
